...
st.write("--- Debugging Model Loading Status ---")
st.write(f"Scaler loaded: {'scaler' in assets and assets['scaler'] is not None}")
st.write(f"XGB model loaded (xgb_smote): {'xgb_smote' in assets and assets['xgb_smote'] is not None}")
st.write(f"ANN Class Weights loaded: {'ann_class_weights' in assets and assets['ann_class_weights'] is not None}")
st.write(f"ANN SMOTE loaded: {'ann_smote' in assets and assets['ann_smote'] is not None}")
st.write(f"ANN Focal Loss loaded: {'ann_focal_loss' in assets and assets['ann_focal_loss'] is not None}")
st.write(f"X_train_columns loaded: {'X_train_columns' in assets and assets['X_train_columns'] is not None}")
st.write("--- End Debugging Model Loading Status ---")
